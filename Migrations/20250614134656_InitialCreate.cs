        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Passport = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsuranceCases_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payouts_InsuranceCases_InsuranceCaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceCases_PolicyId",
                table: "InsuranceCases",
                column: "PolicyId");

            migrationBuilder.CreateIndex(
                name: "IX_Payouts_InsuranceCaseId",
                table: "Payouts",
